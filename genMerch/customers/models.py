...
class Person(main_models.SoftDeletionModel):
    first_name = custom_fields.TitleCaseCharfield(max_length=globals.DEFAULT_MAX_LENGTH)
    middle_name = custom_fields.TitleCaseCharfield(
        max_length=globals.DEFAULT_MAX_LENGTH, null=True, blank=True, default=""
    )
    last_name = custom_fields.TitleCaseCharfield(max_length=globals.DEFAULT_MAX_LENGTH)
    ...
    city = custom_fields.TitleCaseCharfield(max_length=globals.DEFAULT_MAX_LENGTH)
    province = custom_fields.TitleCaseCharfield(max_length=globals.DEFAULT_MAX_LENGTH)
    zip_code = models.PositiveIntegerField()
    country = custom_fields.TitleCaseCharfield(max_length=globals.DEFAULT_MAX_LENGTH)
    ...
    father_name = custom_fields.TitleCaseCharfield(max_length=globals.LONG_MAX_LENGTH)
    father_occupation = custom_fields.TitleCaseCharfield(
        max_length=globals.DEFAULT_MAX_LENGTH, null=True, blank=True, default=""
    )

    mother_name = custom_fields.TitleCaseCharfield(max_length=globals.LONG_MAX_LENGTH)
